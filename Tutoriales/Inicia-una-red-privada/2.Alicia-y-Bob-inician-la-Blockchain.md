...
| --ws-port 9945    | Especifica el puerto por el que tu nodo escuchará el tráfico del socket de web(socket web). El puerto por defecto es el 9944, así que también puede ser omitido. Este ejemplo utiliza un puerto de socket web personalizado.                                                            |
